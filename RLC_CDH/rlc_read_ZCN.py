...
class RLC:
    ...
    def read_zA(self):
        ...
        self.ser.write("FREQ 1000\n")
        self.ser.write("CIRC_SER\n")
        self.ser.write("AVG 10\n")
        #self.ser.write("MODE_ZFI;MON_VI\n")
        #self.ser.write("*TRG;Z?; FI?; MON_V? ; MON_I?\n")
        self.ser.write("MODE_ZFI\n")
        self.ser.write("*TRG;Z?; FI?\n")
...
if __name__ == "__main__":
    ...
    print time.strftime('%X '), time.strftime('%x '), rlc.read_zA()
